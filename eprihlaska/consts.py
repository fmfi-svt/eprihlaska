...
INVALID_TOKEN_MSG = _(
    "Váš token na zmenu hesla je neplatný. Vyplnte prosím Váš email znovu."
)  # noqa
...
FLASH_MSG_DATA_NOT_SAVED = _(
    "Vaše dáta neboli uložené, vyplnený formulár obsahuje chybu! Opravte vyznačené chyby a uložte dáta znovu."
)
...
PERSONAL_INFO_CHECK = _(
    "Dávam súhlas, aby vysoká škola spracúvala moje osobné údaje obsiahnuté v tejto prihláške a jej prílohách na účely prijímacieho konania až do termínu konania zápisu do 1. ročníka štúdia na vysokej škole."
)  # noqa
...
STUDY_PROGRAMME_DESC = _(
    "Vyberte si aspoň jeden a najviac tri študijné programy. Poradie študijných programov vyjadruje preferenciu uchádzača a je záväzné, napr. v prípade splnenia podmienok na dva študijné programy bude uchádzač prijatý na ten, ktorý bude uvedený na prvom mieste."
)  # noqa
STUDY_PROGRAMME_CHOICES = [
    ("_", _("žiaden")),
    ("MAT", PRG_MAT),
    ("PMA", PRG_PMA),
    ("EFM", PRG_EFM),
...
ADDRESS_STREET_DESC = _(
    "V prípade, že sa jedná o malú obec bez názvov ulíc, napíšte názov obce."
)  # noqa

PERMANENT_ADDRESS = _("Adresa trvalého bydliska")
HAS_CORRESPONDENCE_ADDRESS = _(
    "Korešpondenčná adresa sa nezhoduje s adresou trvalého bydliska"
)  # noqa
CORRESPONDENCE_ADDRESS = _("Korešpondenčná adresa")

HAS_PREVIOUSLY_STUDIED = _(
    "V minulosti som študoval(a) na vysokej škole v SR v I. stupni štúdia alebo v spojenom I. a II. stupni štúdia (úspešne alebo neúspešne)"
)  # noqa
...
HIGHSCHOOL_DESC = _(
    'V prípade, že vaša stredná škola nie je v zozname, zvoľte možnosť "Moja stredná škola nie je v zozname" (na začiatku zoznamu)'
)  # noqa
STUDY_PROGRAMME_CODE = _("Kód študijného odboru")
STUDY_PROGRAMME_CODE_DESC = _(
    'Kód študijného odboru je uvedený na vašom vysvedčení. V prípade, že na vysvedčení nemáte uvedený jeden z týchto študijných kódov, zvoľte "nemám kód študijného odboru" (na začiatku zoznamu)'
)  # noqa
HS_EDUCATION_LEVEL = _("Dosiahnuté / očakávané stredoškolské vzdelanie")
FOREIGN_FINISHED_HIGHSCHOOL = _(
    "Absolvoval(a) som / absolvujem strednú školu s maturitou mimo SR"
)  # noqa
...
COMPETITION_CHOICES = [
    ...
    (
        "MAT",
        _(
            "úspešný riešiteľ - Matematická olympiáda A alebo B - krajské alebo celoštátne kolo"
        ),
    ),  # noqa
    (
        "FYZ",
        _(
            "úspešný riešiteľ - Fyzikálna olympiáda A alebo B - krajské alebo celoštátne kolo"
        ),
    ),  # noqa
    (
        "INF",
        _(
            "úspešný riešiteľ - Olympiáda v informatike A alebo B - krajské alebo celoštátne kolo"
        ),
    ),  # noqa
    (
        "BIO",
        _(
            "úspešný riešiteľ - Biologická olympiáda A alebo B - krajské alebo celoštátne kolo"
        ),
    ),  # noqa
    (
        "CHM",
        _(
            "úspešný riešiteľ - Chemická olympiáda A alebo B - krajské alebo celoštátne kolo"
        ),
    ),  # noqa
    (
        "SOC_MAT",
        _(
            "úspešný účastník - Stredoškolská odborná činnost odbor 02 matematika, fyzika - celoštátne kolo"
        ),
    ),  # noqa
    (
        "SOC_INF",
        _(
            "úspešný účastník - Stredoškolská odborná činnosť odbor 11 informatika - celoštátne kolo"
        ),
    ),  # noqa
    (
        "SOC_BIO",
        _(
            "úspešný účastník - Stredoškolská odborná činnosť odbor 04 biológia - celoštátne kolo"
        ),
    ),  # noqa
    (
        "SOC_CHM",
        _(
            "úspešný účastník - Stredoškolská odborná činnosť odbor 03 chémia, potravinárstvo - celoštátne kolo"
        ),
    ),  # noqa
    ...
    (
        "FVAT_MAT",
        _(
            "úspešný účastník - Festival vedy a techniky kategória Matematika - celoštátne kolo"
        ),
    ),
    (
        "FVAT_FYZ",
        _(
            "úspešný účastník - Festival vedy a techniky kategória Fyzika a astronómia - celoštátne kolo"
        ),
    ),
    (
        "FVAT_INF",
        _(
            "úspešný účastník - Festival vedy a techniky kategória Informatika a počítačové inžinierstvo - celoštátne kolo"
        ),
    ),
    (
        "FVAT_BIO",
        _(
            "úspešný účastník - Festival vedy a techniky kategória Biológia - celoštátne kolo"
        ),
    ),
    (
        "FVAT_CH",
        _(
            "úspešný účastník - Festival vedy a techniky kategória Chémia - celoštátne kolo"
        ),
    ),
    ...
    (
        "TROJSTEN_KMS",
        _(
            "65% bodov v ľubovoľnej kategórii - KMS (TROJSTEN) - ktorýkoľvek ročník a časť"
        ),
    ),
    (
        "TROJSTEN_FKS",
        _(
            "65% bodov v ľubovoľnej kategórii - FKS (TROJSTEN) - ktorýkoľvek ročník a časť"
        ),
    ),
    (
        "TROJSTEN_KSP",
...
COMPETITION_FURTHER_INFO_DESC = _(
    "V prípade krajského kola do tohto poľa prosím napíšte názov kraja, v ktorom sa daná súťaž konala. V prípade iných kôl do tohto poľa prosím vpíšte akékoľvek iné informácie, ktoré by mohli pomôcť pri identifikácii vášho úspechu."
)  # noqa
...
EXTERNAL_MATURA_PERCENTILE = _(
    "percentil externej maturity z matematiky "
...
SCIO_CERT_NO_DESC = _(
    "V prípade, že ste autorizovanú skúšku z matematiky (SCIO) už v minulosti absolvovali, do tohto poľa prosím napíšte číslo certifikátu, ktorý ste po jej vykonaní obdržali. Zrýchlite tak proces spracovania Vašej prihlášky. Ďakujeme!"
)  # noqa
...
WILL_TAKE_EXT_MAT = _(
    "zúčastním sa externej maturity z matematiky (SR) /"
...
FINAL_NOTE_DESC = _(
    "Prosím, informujte nás o skutočnostiach, ktoré by mohli byť pre Vašu prihlášku relevantné a neboli spomenuté v už vyplnených častiach."
)  # noqa
...
FORGOTTEN_PASSWORD_MAIL = _(
    "V rámci systému elektronickej prihlášky FMFI UK bol pre Váš účet aktivovaný postup pre zmenu zabudnutého hesla. Ak chcete heslo zmeniť, použite nasledujúci link: {}\n\nV inom prípade prosím tento email ignorujte.\n\nS pozdravom,\nhttps://prihlaska.fmph.uniba.sk"
)  # noqa

FORGOTTEN_PASSWORD_MSG = _(
    "Ak bol poskytnutý e-mail nájdený, boli naň zaslané informácie o ďalšom postupe."
)  # noqa

NEW_USER_MAIL = _(
    "Vitajte v systéme elektronickej prihlášky FMFI UK. Pre vytvorenie hesla a následné prihlásenie prosím použite nasledujúci link: {}\n\nS pozdravom,\nhttps://prihlaska.fmph.uniba.sk"
)  # noqa

NEW_USER_MSG = _(
    "Nový používateľ bol zaregistrovaný. Pre zadanie hesla prosím pokračujte podľa pokynov zaslaných na zadaný email."
)  # noqa

YEAR_ERR = _(
    "Nesprávne zadaná hodnota. Akceptované hodnoty sú v rozsahu od %(min)s po %(max)s"
)  # noqa

SEX_CHOICES = [("male", MALE), ("female", FEMALE)]
COUNTRY_CHOICES = choices_from_csv(
    DIR + "/data/staty.csv", ["id", "Štát"], sortby=1, prepend=["703", "203"]
)

SELECT_CITY_CHOICE = [("999999", _("Zvoľte mesto alebo obec v SR"))]
CITY_CHOICES = choices_from_csv(
    DIR + "/data/obce.csv",
    ["id", "Názov obce", "Okres"],
    fmt="{1}, okr. {2}",
...
CITY_CHOICES_PSC = choices_from_csv(DIR + "/data/obce.csv", ["id", "PSČ"], fmt="{1}")

MARITAL_STATUS_CHOICES = choices_from_csv(
    DIR + "/data/rodinne-stavy.csv", ["id", "Rodinný stav"]
)

LENGTH_OF_STUDY = "Dĺžka štúdia na strednej škole"
LENGTH_OF_STUDY_CHOICES = [
    ("4", _("4 roky")),
    ("5", _("5 rokov")),
    ("8", _("8 rokov")),
    ("0", _("iná")),
...
HIGHSCHOOL_CHOICES = choices_from_csv(
    DIR + "/data/skoly.csv",
    ["St. šk.", "Obec", "Stredná škola", "Ulica"],
    fmt="{1}, {2}, {3}",
...
HS_STUDY_PROGRAMME_CHOICES = choices_from_csv(
    DIR + "/data/odbory.csv",
    ["Odbor - kod", "Odbor stred. školy"],
    extend_with=NO_SP_CHOICE,
    prepend=["XXXXXX"],
    fmt="{0} - {1}",
)

HS_STUDY_PROGRAMME_MAP = choices_from_csv(
    DIR + "/data/ss-odbor-map.csv", ["St. šk.", "Odbor - kod"], fmt="{1}"
)

EDUCATION_LEVEL_CHOICES = choices_from_csv(
    DIR + "/data/vzdelanie.csv", ["Kód", "Skrát. popis"], fmt="({0}) - {1}"
)

APPLICATION_STATES = [_("rozpracovaná"), _("podaná"), _("vytlačená"), _("spracovaná")]
