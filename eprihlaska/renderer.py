...
from flask_nav3.elements import NavigationItem, View
...
class ExtendedNavbar(NavigationItem):
    def __init__(
        self, title, root_class="navbar navbar-default", items=[], right_items=[]
    ):
        self.title = title
...
class ePrihlaskaNavRenderer(BootstrapRenderer):
    ...
    def visit_View(self, node):
        ...
        if "application_submitted" in session and endpoint not in allowed_endpoints:
            url = "#"
